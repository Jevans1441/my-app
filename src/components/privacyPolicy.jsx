      ...
      <ul>
        <p>
          ...
          <li className="policy-list">
            ...
            downloaded by You on any electronic device, named Contact App
          </li>
          <li className="policy-list">
            Company (referred to as either "the Company", "We", "Us" or "Our" in
            this Agreement) refers to Contact App.
          </li>
          <li className="policy-list">
          ...
          <li className="policy-list">Service refers to the Application.</li>
          <li className="policy-list">
